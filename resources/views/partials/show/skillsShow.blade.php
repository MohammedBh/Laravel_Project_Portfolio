<div class="modal fade" id="exampleModalToggle_{{ $skillsDyns->id }}" aria-hidden="true" role="dialog"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-info">
                ...
                <div class="card " style="width: 100%;">
                    <div class="card-body">
                        <div class="mb-5">
                            ...
                            <h4>{{ $skillsDyns->span }}</h4>
                        </div>
                        <div class="border-bottom"></div>
                        <div class="mt-5">
                            <h3 class="text-primary">Pourcentage</h3>
                            <h4>{{ $skillsDyns->pourcentage }} %</h4>
                        </div>
                    </div>
                </div>
            </div>
            <div class="modal-footer">
                ...
                <a href="/contenuSkillsDynamic/{{ $skillsDyns->id }}/edit" class="btn btn-success mx-2 text-white"
                    data-target="#exampleModalToggle2_{{ $skillsDyns->id }}" data-toggle="modal"
                    data-dismiss="modal">EDIT</a>
            </div>
        </div>
    </div>
</div>
<div class="modal fade" id="exampleModalToggle2_{{ $skillsDyns->id }}" aria-hidden="true"
    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content bg-info">
            ...
            <div class="modal-body ">
                <form action="/backoffice/skillsDync/{{ $skillsDyns->id }}/update" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label text-white">Span</label>
                        <input type="text" class="form-control" value="{{ $skillsDyns->span }}" name="span"
                            id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputPassword1" class="form-label text-white">Pourcentage</label>
                        <input type="number" min="0" max="100"  class="form-control" value="{{ $skillsDyns->pourcentage }}"
